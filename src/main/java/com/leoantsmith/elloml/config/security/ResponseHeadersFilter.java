...
public class ResponseHeadersFilter implements Filter {
    ...
    public void doFilter(
        ...
        httpResponse.setHeader("Content-Security-Policy", "default-src 'self' https://dev-bclv4dcp3qrp635b.us.auth0.com/ https://i0.wp.com/cdn.auth0.com https://s.gravatar.com; frame-ancestors 'none';");
